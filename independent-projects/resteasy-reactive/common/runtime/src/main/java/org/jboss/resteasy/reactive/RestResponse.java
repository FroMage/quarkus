...
public abstract class RestResponse<T> implements AutoCloseable {
     ...
     * @since 2.0
     */
    public abstract <OtherT> T readEntity(GenericType<OtherT> entityType, Annotation[] annotations);
...
//            return RuntimeDelegate.getInstance().createResponseBuilder();
         ...
         *                                  than {@code 599}.
         */
        public abstract <Ret extends T> ResponseBuilder<T> status(int status);
    ...
    public enum Status implements StatusType {
        ...
        /**
         * 101 Switching Protocols, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.2.2">HTTP/1.1 documentation</a>}.
         */
        ...
        /**
         * 203 Non-Authoritative Information, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.3.4">HTTP/1.1 documentation</a>}.
         */
        ...
        /**
         * 205 Reset Content, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.3.5">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        ...
        /**
         * 300 Multiple Choices, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.4.1">HTTP/1.1 documentation</a>}.
         */
        MULTIPLE_CHOICES(StatusCode.MULTIPLE_CHOICES, "Multiple Choices"),
        /**
         * 301 Moved Permanently, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.4.2">HTTP/1.1 documentation</a>}.
         */
        ...
        /**
         * 307 Temporary Redirect, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.4.7">HTTP/1.1 documentation</a>}.
         */
        TEMPORARY_REDIRECT(StatusCode.TEMPORARY_REDIRECT, "Temporary Redirect"),
        /**
         * 308 Permanent Redirect, see {@link <a href="https://tools.ietf.org/html/rfc7238#section-3">HTTP/1.1 documentation</a>}.
         */
        ...
        /**
         * 402 Payment Required, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.5.2">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        ...
        /**
         * 405 Method Not Allowed, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.5.5">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        METHOD_NOT_ALLOWED(StatusCode.METHOD_NOT_ALLOWED, "Method Not Allowed"),
        /**
         * 406 Not Acceptable, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.5.6">HTTP/1.1 documentation</a>}.
         */
        NOT_ACCEPTABLE(StatusCode.NOT_ACCEPTABLE, "Not Acceptable"),
        /**
         * 407 Proxy Authentication Required, see {@link <a href="https://tools.ietf.org/html/rfc7235#section-3.2">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        PROXY_AUTHENTICATION_REQUIRED(StatusCode.PROXY_AUTHENTICATION_REQUIRED, "Proxy Authentication Required"),
        /**
         * 408 Request Timeout, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.5.7">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        ...
        /**
         * 411 Length Required, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.5.10">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        LENGTH_REQUIRED(StatusCode.LENGTH_REQUIRED, "Length Required"),
        /**
         * 412 Precondition Failed, see {@link <a href="https://tools.ietf.org/html/rfc7232#section-4.2">HTTP/1.1 documentation</a>}.
         */
        PRECONDITION_FAILED(StatusCode.PRECONDITION_FAILED, "Precondition Failed"),
        /**
         * 413 Payload Too Large, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.5.11">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        PAYLOAD_TOO_LARGE(StatusCode.PAYLOAD_TOO_LARGE, "Payload Too Large"),
        /**
         * 414 URI Too Long, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.5.12">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        URI_TOO_LONG(StatusCode.URI_TOO_LONG, "URI Too Long"),
        /**
         * 415 Unsupported Media Type, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.5.13">HTTP/1.1 documentation</a>}.
         */
        UNSUPPORTED_MEDIA_TYPE(StatusCode.UNSUPPORTED_MEDIA_TYPE, "Unsupported Media Type"),
        /**
         * 416 Requested Range Not Satisfiable, see {@link <a href="https://tools.ietf.org/html/rfc7233#section-4.4">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        REQUESTED_RANGE_NOT_SATISFIABLE(StatusCode.REQUESTED_RANGE_NOT_SATISFIABLE, "Requested Range Not Satisfiable"),
        /**
         * 417 Expectation Failed, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.5.14">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        EXPECTATION_FAILED(StatusCode.EXPECTATION_FAILED, "Expectation Failed"),
        /**
         * 426 Upgrade Required, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.5.15">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        ...
        /**
         * 500 Internal Server Error, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.6.1">HTTP/1.1 documentation</a>}.
         */
        INTERNAL_SERVER_ERROR(StatusCode.INTERNAL_SERVER_ERROR, "Internal Server Error"),
        /**
         * 501 Not Implemented, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.6.2">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        ...
        /**
         * 503 Service Unavailable, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.6.4">HTTP/1.1 documentation</a>}.
         */
        SERVICE_UNAVAILABLE(StatusCode.SERVICE_UNAVAILABLE, "Service Unavailable"),
        /**
         * 504 Gateway Timeout, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.6.5">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
        GATEWAY_TIMEOUT(StatusCode.GATEWAY_TIMEOUT, "Gateway Timeout"),
        /**
         * 505 HTTP Version Not Supported, see {@link <a href="https://tools.ietf.org/html/rfc7231#section-6.6.6">HTTP/1.1 documentation</a>}.
         *
         * @since 2.0
         */
